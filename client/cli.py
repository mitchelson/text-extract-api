...
def ocr_upload(file_path, ocr_cache, prompt, prompt_file=None, model='llama3.1', strategy='llama_vision', storage_profile='default', storage_filename=None, language='en'):
    ocr_url = os.getenv('OCR_UPLOAD_URL', 'http://localhost:2323/ocr/upload')
...
def ocr_request(file_path, ocr_cache, prompt, prompt_file=None, model='llama3.1', strategy='llama_vision', storage_profile='default', storage_filename=None, language='en'):
    ocr_url = os.getenv('OCR_REQUEST_URL', 'http://localhost:2323/ocr/request')
...
def get_result(task_id, print_progress = False):
    ...
    result_url = os.getenv('RESULT_URL', f'http://localhost:2323/ocr/result/')
    while True:
...
def clear_cache():
    clear_cache_url = os.getenv('CLEAR_CACHE_URL', 'http://localhost:2323/ocr/clear_cache')
...
def llm_generate(prompt, model = 'llama3.1'):
    ollama_url = os.getenv('LLM_GENERATE_API_URL', 'http://localhost:2323/llm/generate')
...
def list_files(storage_profile):
    list_files_url = os.getenv('LIST_FILES_URL', 'http://localhost:2323/storage/list')
...
def load_file(file_name, storage_profile):
    load_file_url = os.getenv('LOAD_FILE_URL', 'http://localhost:2323/storage/load')
...
def delete_file(file_name, storage_profile):
    delete_file_url = os.getenv('DELETE_FILE_URL', 'http://localhost:2323/storage/delete')
